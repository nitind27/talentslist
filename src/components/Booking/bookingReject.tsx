...
const BookingReject = async ({ booking_code, getbookingcode }: { booking_code: string, getbookingcode: IBookingCode }) => {
    ...
    return (
        <div className='card mb-xxl-8 mb-5'>
            <div className='card-body pt-9 pb-9'>
                ...
                <div className='pt-5'>
                    <label className="fs-2 w-100 fw-bold border-bottom pb-4">Rejection details</label>
                    <div className='pt-5'>

                        <div className="d-flex pb-3">
                            <label className="talent_fees_label">Rejected on:</label>
                            <span className="talent_fees_span">{Data.rejected_at || "-"}</span>
                        </div>
                        <div className="d-flex">
                            <label className="talent_fees_label">Reason:</label>
                            <span className="talent_fees_span">{Data.reject_reason || "-"}</span>
                        </div>
                    </div>
                </div>
            </div>
