...
const BookingCancelled = async ({ booking_code, getbookingcode }: { booking_code: string, getbookingcode: IBookingCode }) => {
    ...
    return (
        ...
        <div className='card mb-xxl-8 mb-5'>
            <div className='card-body pt-9 pb-9'>
                <label className='withdrawal_label custom-text'>BOOKING CODE - {Data.booking_code}</label>
                <div className=" d-flex align-items-center g-10 border-bottom pb-4 justify-content-between">
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="py-2 px-3 badge text-bg-danger rounded-1">{status.title}</span>
                    </div>
                </div>
                ...
                <div className='d-flex pt-4 pb-4'>
                    ...
                    <div className='px-5 border-start border-end d-flex flex-column'>
                        ...
                        <span className=''>
                            <Link href='#' className='mt-1 text-black fs-6 fw-bold'>{Data.client.first_name || "-"}{" "}{Data.client.last_name}</Link>
                        </span>
                    </div>
                ...
                <div className='pt-5'>
                    <label className="fs-2 w-100 fw-bold border-bottom pb-4">Cancellation details</label>
                    <div className='pt-5'>
                        <div className="d-flex pb-3">
                            <label className="talent_fees_label">Cancelled on:</label>
                            <span className="talent_fees_span">{Data.cancelled_at || "-"}</span>
                        </div>
                        <div className="d-flex pb-3">
                            <label className="talent_fees_label">Cancelled by:</label>
                            <span className="talent_fees_span">{Data.cancelled_by || "-"}</span>
                        </div>
                        <div className="d-flex">
                            <label className="talent_fees_label">Reason:</label>
                            <span className="talent_fees_span">{Data.cancelled_reason || "-"}</span>
                        </div>
                    </div>
                </div>
            </div>
