...
const BookingUpcoming = async ({ booking_code,getbookingcode}: { booking_code: string,getbookingcode: IBookingCode}) => {
    // const response = await getbookingsCode(booking_code)
            ...
            <div className='card-body pt-9 pb-9'>
                ...
                <div className="d-flex align-items-center g-10 border-bottom pb-4 justify-content-between">
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="py-2 px-3 badge text-bg-info rounded-1">{status.title || "-"}</span>
                    </div>
                </div>
