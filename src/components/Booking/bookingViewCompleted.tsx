...
const BookingViewCompleted = async ({ booking_code,getbookingcode}: { booking_code: string,getbookingcode: IBookingCode}) =>{
...
export default BookingViewCompleted;