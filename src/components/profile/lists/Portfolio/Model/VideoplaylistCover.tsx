...
import { addfeaturedvideosalbums } from "@/api/profile/portfolio/addfeaturedphotos";
import { toast } from "react-toastify";

interface VideoPlaylistCoverProps {
  onAlbumAdded: () => void;

  data: any;
}

const VideoPlaylistCover: React.FC<VideoPlaylistCoverProps> = ({
  onAlbumAdded,
    ...
    onSubmit: async (values) => {
      if (selectedImage) {
        try {
          ...
          const response = await addfeaturedvideosalbums(
            values.title,
            selectedImage
          );
          ...
          if (response.error) {
            ...
            toast.success("Video Cover has been successfully uploaded.", {
              onClose: handleClose,
            });
          ...
          toast.error("Video Cover upload failed. Please try again later.", {
            onClose: handleClose,
          });
...
export default VideoPlaylistCover;
