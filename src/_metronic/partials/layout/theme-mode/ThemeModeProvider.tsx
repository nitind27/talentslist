...
const themeModeSwitchHelper = (_mode: ThemeModeType) => {
  ...
  const imageUrl =
    "//patterns/header-bg" + (mode === "light" ? ".jpg" : "-dark.jpg");
...
const ThemeModeProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const updateMode = (
    ...
    console.log("jsalflsdl I am here olds", saveInLocalStorage);
    if (saveInLocalStorage && localStorage) {
      console.log("jsalflsdl I am here ", saveInLocalStorage);
  ...
  const updateMenuMode = (
    ...
    console.log("jsalflsdl I am heresd  updateMenuMode", saveInLocalStorage);
